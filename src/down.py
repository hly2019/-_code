...
# down_test = cv2.imread("../数据/input3/result_img004.jpg")
...
# cv2.imwrite("../数据/down_input4_mask.jpg", down_input1_masked)

# cv2.imwrite("../数据/input1/down_result_img004.jpg", down_test)
